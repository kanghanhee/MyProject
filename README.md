...
#### 1. [빵동여지도 ver.2](빵동여지도ver2.md) : 후회없는 빵 선택을 도와줄 브레드 맵, 지도기반 빵집 추천 플랫폼
...
#### 2. [소복소복](소복소복.md) : 소중한 사람들과 공유하는 복약 체크 서비스
...
#### 4. [CO-EAT](CO-EAT.md) : 모두가 행복한, 점심 메뉴 투표 및 취합 서비스
- [웹페이지 출시](https://www.coeat.site) ~~현재 중지~~

#### 5. [빵동여지도 ver.1](빵동여지도ver1.md) : 후회없는 빵 선택을 도와줄 브레드 맵, 지도기반 빵집 추천 플랫폼
- 앱 출시 [iOS](https://apps.apple.com/kr/app/%EB%B9%B5%EB%8F%99%EC%97%AC%EC%A7%80%EB%8F%84/id1595032110), [AOS](https://play.google.com/store/apps/details?id=bbangmap.com&pli=1)

#### 6. [TAKEUS](TAKEUS.md) : 유기견과 해외 이동봉사자 매칭 플랫폼
